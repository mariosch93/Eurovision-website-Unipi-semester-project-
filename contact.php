...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO user_info (firstname, address, zip, phonenumber, email, password, country) 
            VALUES ('" . mysqli_real_escape_string($dbconn, $_POST['firstname']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['address']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['zip']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['phonenumber']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['email']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['password']) . "',
                    '" . mysqli_real_escape_string($dbconn, $_POST['country']) . "')";
